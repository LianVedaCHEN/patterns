/****************************************************************************
** Meta object code from reading C++ file 'PointPlotterWindow.h'
**
...
#error "The header file 'PointPlotterWindow.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_PointPlotter[] = {
    "PointPlotter\0\0bruteMethod()\0fastMethod()\0"
    "aboutMe()\0"
};
...
void PointPlotter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->bruteMethod(); break;
        case 1: _t->fastMethod(); break;
